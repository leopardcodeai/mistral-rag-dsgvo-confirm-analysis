# Complete Colab Fine-Tuning Script - Mistral 3B
...
subprocess.check_call([sys.executable, "-m", "pip", "install", "-q", 
    "transformers", "datasets", "boto3", "accelerate", "torch"])
...
# ==========================================
# 4. LOAD MODEL (Mistral 3B - OPEN WEIGHTS!)
# ==========================================
...
print!("✓ Mistral 3B Open Weights model - European (France)!")
